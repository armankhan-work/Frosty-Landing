            ...
            {animationStarted && (
              ...
              >
                ...
                <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ overflow: 'visible' }}>
                  ...
                  <motion.line
                    x1="400" y1="80" x2="400" y2="380"
                    stroke="#8B5CF6" strokeWidth="2" strokeDasharray="4 4" // Purple for Brain
                    initial={{ pathLength: 0, opacity: 0 }}
                    animate={{ pathLength: 1, opacity: 1 }}
                  ...
                  <motion.line
                    x1="400" y1="380" x2="100" y2="380"
                    stroke="#3B82F6" strokeWidth="2" strokeDasharray="4 4" // Blue for Calendar
                    initial={{ pathLength: 0, opacity: 0 }}
                    animate={{ pathLength: 1, opacity: 1 }}
                ...
                <motion.div 
                  className="absolute top-[356px] left-[376px] w-12 h-12 bg-gradient-to-tr from-purple-100 to-purple-50 rounded-full flex items-center justify-center border border-purple-200 z-10 cursor-pointer pointer-events-auto"
                  initial={{ scale: 0 }} 
                  animate={{ scale: 1, boxShadow: "0px 4px 6px -1px rgba(0, 0, 0, 0.1)" }} 
