...
import { User, Globe, Brain, Headset, ArrowDown } from 'lucide-react';
            ...
            {animationStarted && (
              ...
              >
                <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ overflow: 'visible' }}>
                  ...
                  <motion.line x1="100" y1="80" x2="400" y2="80" stroke="#FF7A5E" strokeWidth="2" strokeDasharray="4 4"
                  ...
                  <motion.line x1="400" y1="80" x2="400" y2="380" stroke="#14B8A6" strokeWidth="2" strokeDasharray="4 4"
                  ...
                  <motion.line x1="400" y1="380" x2="100" y2="380" stroke="#F97316" strokeWidth="2" strokeDasharray="4 4"
                  ...
                  <motion.line x1="100" y1="380" x2="100" y2="80" stroke="#F43F5E" strokeWidth="2" strokeDasharray="4 4"
                ...
                <motion.div className="absolute top-[356px] left-[376px] w-12 h-12 bg-gradient-to-tr from-teal-100 to-teal-50 rounded-full flex items-center justify-center border border-teal-200 z-10 cursor-pointer pointer-events-auto"
                ...
                <motion.div className="absolute top-[356px] left-[76px] w-12 h-12 bg-gradient-to-tr from-orange-100 to-orange-50 rounded-full flex items-center justify-center border border-orange-200 z-10 cursor-pointer pointer-events-auto"
                  initial={{ scale: 0 }} animate={{ scale: 1, boxShadow: "0px 4px 6px -1px rgba(0, 0, 0, 0.1)" }} transition={{ delay: 0.8, type: 'spring' }}
                  whileHover={{ scale: 1.25, rotate: 10, boxShadow: "0px 20px 40px -5px rgba(249, 115, 22, 0.8)" }}>
                ...
                <motion.div initial={{ opacity: 0, scale: 0.8, x: "-50%", y: "-50%" }} animate={{ opacity: 1, scale: 1, x: "-50%", y: "-50%" }} transition={{ duration: 0.5, delay: 5 }}
                  className="absolute top-[380px] left-[250px] bg-orange-100 text-orange-800 text-[11px] font-bold px-3 py-1.5 rounded-full border border-orange-300 z-20 shadow-sm whitespace-nowrap">
                  Transferring full chat history...
                </motion.div>

                <motion.div initial={{ opacity: 0, scale: 0.8, x: "-50%", y: "-50%" }} animate={{ opacity: 1, scale: 1, x: "-50%", y: "-50%" }} transition={{ duration: 0.5, delay: 7 }}
                  className="absolute top-[230px] left-[100px] bg-rose-500 text-white text-[11px] p-2 rounded-2xl shadow-xl w-[140px] z-20 leading-tight text-center border border-rose-400 font-medium">
                  Live chat handed to your team!
                </motion.div>
