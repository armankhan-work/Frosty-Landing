...
export default function DoneForYou() {
    ...
    const renderCompactPreview = (stepIdx: number) => {
        if (stepIdx === 0) {
            return (
                <div className="bg-gradient-to-r from-[#1e293b]/80 to-[#020617] text-white rounded-xl px-3.5 h-[46px] mb-5 flex items-center justify-between text-[11px] shadow-sm border border-[#3B82F6]/30 shrink-0">
                    ...
                    <span className="bg-[#3B82F6]/20 text-[#60A5FA] font-mono px-2 py-0.5 rounded text-[10px] shrink-0 border border-[#3B82F6]/30 font-bold">100% READY</span>
                </div>
            );
        } else if (stepIdx === 1) {
            return (
                <div className="bg-gradient-to-r from-[#1e293b]/80 to-[#020617] text-white rounded-xl px-3.5 h-[46px] mb-5 flex items-center justify-between text-[11px] shadow-sm border border-[#3B82F6]/30 shrink-0">
                    ...
                    <span className="bg-[#3B82F6]/20 text-[#60A5FA] font-mono px-2 py-0.5 rounded text-[10px] shrink-0 border border-[#3B82F6]/30 font-bold">0 ERRORS</span>
                </div>
            );
        } else {
            return (
                <div className="bg-gradient-to-r from-[#1e293b]/80 to-[#020617] text-white rounded-xl px-3.5 h-[46px] mb-5 flex items-center justify-between text-[11px] shadow-sm border border-[#3B82F6]/30 shrink-0">
                    ...
                    <span className="bg-[#3B82F6] text-white font-mono px-2 py-0.5 rounded text-[10px] shrink-0 font-bold animate-pulse">CONVERTING</span>
                </div>
            );
        }
    };
    ...
    return (
        <section id="setup" className="relative w-full overflow-hidden font-sans pt-24 pb-32 bg-transparent">
            ...
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden -z-10">
                <div className="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-[#3B82F6]/[0.03] blur-[120px]" />
                <div className="absolute bottom-[10%] right-[10%] w-[40%] h-[40%] rounded-full bg-[#3B82F6]/[0.03] blur-[100px]" />
                ...
                <svg className="absolute bottom-0 left-0 w-full h-full opacity-30" viewBox="0 0 1000 1000" preserveAspectRatio="none">
                    <path d="M0,1000 C200,800 400,1000 1000,600" fill="none" stroke="#3B82F6" strokeWidth="0.5" strokeDasharray="4 8" />
                    <path d="M0,900 C300,700 500,900 1000,500" fill="none" stroke="#3B82F6" strokeWidth="0.5" strokeDasharray="4 8" />
                </svg>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between gap-12 lg:gap-8 w-full relative z-10">
                ...
                <div className="w-full lg:w-[45%] flex flex-col justify-center">
                    ...
                    >
                        <span className="text-[#3B82F6]">The Frosty team</span><br />
                    ...
                    <motion.div
                        ...
                        className="h-[2px] bg-[#3B82F6]/60 mb-8"
                    />
                    ...
                    >
                        <div className="flex items-start w-full relative px-2 sm:px-4">
                            ...
                            <div 
                                className="absolute top-2 left-[16.66%] h-[2px] bg-[#3B82F6] transition-all duration-500 ease-out" 
                            ...
                            <div onClick={() => { setCurrentStep(0); setIsCompleted(false); }} className="flex-1 flex flex-col items-center relative cursor-pointer group">
                                <div className={`w-4 h-4 rounded-full transition-all duration-300 z-10 mb-3 shadow-sm flex items-center justify-center ${
                                    isCompleted || currentStep > 0 
                                        ...
                                        : currentStep === 0 
                                        ? 'bg-[#020617] border-[2.5px] border-[#3B82F6] shadow-[0_0_0_4px_rgba(59,130,246,0.2)] scale-110' 
                                        : 'bg-[#020617] border-[2px] border-slate-300 group-hover:border-[#3B82F6]'
                                }`}>
                                ...
                                <h5 className={`text-[13px] font-bold transition-colors duration-300 mb-1 ${
                                    isCompleted || currentStep >= 0 ? 'text-[#3B82F6]' : 'text-white group-hover:text-[#3B82F6]'
                                }`}>Discover</h5>
                                <div className="text-[11px] text-center max-w-[130px] leading-tight">
                                    {isCompleted || currentStep > 0 ? (
                                        <span className="text-[#3B82F6] font-semibold flex items-center justify-center gap-1">✓ Completed</span>
                                    ) : currentStep === 0 ? (
                                        <span className="text-[#3B82F6] font-semibold">● In Progress</span>
                                    ) : (
                            ...
                            <div onClick={() => { setCurrentStep(1); setIsCompleted(false); }} className="flex-1 flex flex-col items-center relative cursor-pointer group">
                                ...
                                <h5 className={`text-[13px] font-bold transition-colors duration-300 mb-1 ${
                                    isCompleted || currentStep >= 1 ? 'text-[#3B82F6]' : 'text-white group-hover:text-[#3B82F6]'
                                }`}>Configure</h5>
                                <div className="text-[11px] text-center max-w-[130px] leading-tight">
                                    {isCompleted || currentStep > 1 ? (
                                        <span className="text-[#3B82F6] font-semibold flex items-center justify-center gap-1">✓ Completed</span>
                            ...
                            <div onClick={() => { setCurrentStep(2); if (isCompleted) setIsCompleted(false); }} className="flex-1 flex flex-col items-center relative cursor-pointer group">
                                ...
                                <h5 className={`text-[13px] font-bold transition-colors duration-300 mb-1 ${
                                    isCompleted || currentStep === 2 ? 'text-[#3B82F6]' : 'text-white group-hover:text-[#3B82F6]'
                                }`}>Deploy</h5>
                                <div className="text-[11px] text-center max-w-[130px] leading-tight">
                                    {isCompleted ? (
                                        <span className="text-[#3B82F6] font-semibold flex items-center justify-center gap-1">✓ Completed</span>
                ...
                <div className="w-full lg:w-[55%] relative flex flex-col pt-8 lg:pt-14">
                    ...
                    <div className="relative flex flex-col md:flex-row gap-8 lg:gap-12 w-full h-full">
                        ...
                        <div className="relative md:w-[60%] shrink-0 flex flex-col">
                            ...
                            <div className="absolute -inset-1 rounded-[32px] bg-gradient-to-r from-[#3B82F6]/15 via-blue-500/10 to-indigo-500/10 blur-xl opacity-70 pointer-events-none" />
                            ...
                            >
                                        ...
                                        <div className="flex items-center justify-between mb-4 shrink-0">
                                            <div className="flex items-center gap-3">
                                                <div className={`w-9 h-9 rounded-2xl flex items-center justify-center font-bold text-[13px] shadow-sm transition-all duration-300 ${
                                                    isCompleted ? 'bg-[#3B82F6] text-white' : 'bg-[#1e293b] text-white border border-[#3B82F6]/30'
                                                }`}>
                                                ...
                                                <div>
                                                    ...
                                                    <span className="text-[11px] font-bold text-[#3B82F6] flex items-center gap-1.5 leading-none">
                                            ...
                                            {isCompleted ? (
                                                <button 
                                                    ...
                                                    className="flex items-center gap-1.5 bg-[#3B82F6]/20 hover:bg-[#3B82F6]/30 text-[#60A5FA] px-3 py-1.5 rounded-xl border border-[#3B82F6]/40 text-[11px] font-bold transition-all duration-300 cursor-pointer shadow-2xs shrink-0"
                                                >
                                                    <span>Restart</span>
                                                    <span className="text-[12px] leading-none">↻</span>
                                                </button>
                                            ) : (
                                                <div className="hidden sm:flex items-center gap-1.5 bg-[#1e293b]/60 px-2.5 py-1 rounded-lg border border-[#3B82F6]/30 text-[10px] font-mono font-semibold text-[#60A5FA] shrink-0">
                                                ...
                                                <div 
                                                    ...
                                                    className={`flex items-center gap-2.5 p-2.5 rounded-xl border transition-all duration-300 ${
                                                        isCompleted 
                                                            ...
                                                            : 'bg-[#1e293b]/40 border-[#3B82F6]/20 hover:bg-[#1e293b]/60 hover:border-[#3B82F6] shadow-2xs'
                                                    }`}
                                                >
                                                    <div className={`w-4.5 h-4.5 rounded-md flex items-center justify-center shrink-0 transition-colors duration-300 ${
                                                        isCompleted ? 'bg-[#3B82F6] text-white' : 'bg-[#3B82F6]/20 text-[#60A5FA]'
                                                    }`}>
                                ...
                                <div className="flex items-center justify-between pt-4 border-t border-[#020617] mt-auto shrink-0">
                                    <div className="flex items-center gap-2 bg-[#1e293b]/50 px-3 py-1.5 rounded-xl border border-[#3B82F6]/30 shadow-2xs">
                                        <Clock className="w-4 h-4 text-[#60A5FA]" />
                                        <div className="flex flex-col">
                                            <span className="text-[9px] font-bold tracking-widest text-[#60A5FA] uppercase leading-none mb-0.5">Est. time</span>
                                            <span className={`text-[11px] font-bold leading-none ${isCompleted ? 'text-[#3B82F6]' : 'text-[#60A5FA]'}`}>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        {!isCompleted ? (
                                            <button 
                                                ...
                                                className="px-5 h-9 rounded-full flex items-center gap-2 font-semibold text-[12.5px] bg-[#3B82F6] text-white hover:bg-[#2563EB] active:scale-95 cursor-pointer shadow-md hover:shadow-lg transition-all duration-300"
                                            ...
                                            <button 
                                                ...
                                                className="px-4 h-9 rounded-full flex items-center gap-1.5 font-semibold text-[12.5px] bg-[#3B82F6] text-white hover:bg-[#2563EB] active:scale-95 cursor-pointer shadow-md transition-all duration-300"
                                            >
                                ...
                                {STEPS_DATA.filter((_, idx) => idx !== currentStep).map((step) => {
                                    ...
                                    return (
                                        <motion.div
                                            ...
                                            className="relative cursor-pointer group p-3.5 -ml-3 rounded-2xl hover:bg-[#1e293b]/50 hover:shadow-md transition-all duration-300 border border-transparent hover:border-[#3B82F6]/40"
                                        >
                                            <div className={`absolute -left-[34px] md:-left-4 top-3.5 w-8 h-8 rounded-full flex items-center justify-center font-bold text-[12px] transition-all duration-300 shadow-sm z-10 ${
                                                isStepDone 
                                                    ...
                                                    : 'bg-[#1e293b]/50 text-slate-300 border border-[#3B82F6]/30 group-hover:bg-[#3B82F6] group-hover:text-white group-hover:border-[#3B82F6]'
                                            }`}>
                                            ...
                                            <div className="pl-4 md:pl-10">
                                                <div className="flex items-center gap-2 mb-1 flex-wrap">
                                                    <h4 className={`text-[15px] font-bold leading-snug transition-colors duration-300 ${
                                                        isStepDone ? 'text-slate-200' : 'text-white group-hover:text-[#3B82F6]'
                                                    }`}>
                                                        {step.summaryTitle.replace('\n', ' ')}
                                                    </h4>
                                                    {isStepDone ? (
                                                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#3B82F6]/20 text-[#60A5FA] border border-[#3B82F6]/30 uppercase tracking-wider">
                                                            ✓ Done
                                                        </span>
                                                    ) : (
