...
/**
 * KineticBlurHeading: Fluid, balanced kinetic heading reveal with subtle blur-to-focus slide
 */
              ...
              <div className="grid grid-cols-2 gap-2.5">
                {engineTabs.map((tab, idx) => (
                  <button
                    ...
                    className={`p-3 rounded-xl text-left transition-all text-xs font-semibold flex items-center gap-2 ${
                      activeEngineTab === idx
