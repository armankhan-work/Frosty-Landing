      ...
      <AnimatePresence>
        {started && (
          ...
          >
            ...
            <motion.line x1="400" y1="380" x2="100" y2="380" stroke="#F59E0B" strokeWidth="2.5" strokeDasharray="4 4"
            ...
            <motion.g initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 0.8, type: 'spring' }}>
              <circle cx="100" cy="380" r="24" fill="rgba(245,158,11,0.15)" stroke="rgba(245,158,11,0.4)" strokeWidth="1.5" />
              <text x="100" y="385" textAnchor="middle" fill="#FBBF24" fontSize="20">📄</text>
            </motion.g>
            ...
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 3, duration: 0.4 }}>
              <rect x="310" y="215" width="155" height="28" rx="14" fill="#121212" stroke="rgba(139,92,246,0.5)" strokeWidth="1" />
              <text x="387" y="234" textAnchor="middle" fill="#C4B5FD" fontSize="11" fontWeight="700">Generating quote…</text>
            </motion.g>

            {/* Bubble 3: Quotation ready */}
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 4.8, duration: 0.4 }}>
              <rect x="158" y="367" width="185" height="28" rx="14" fill="#121212" stroke="rgba(245,158,11,0.5)" strokeWidth="1" />
              <text x="250" y="386" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="700">Quotation #218 ready</text>
            </motion.g>
