...
const CHANNELS = [
    {
        ...
        icon: <img src="/web.svg" alt="Website" className="w-5 h-5 object-contain shrink-0" />
    },
    {
        id: 'whatsapp',
        title: 'WhatsApp',
        subtitle: 'New message',
        icon: <img src="/whatsapp.png" alt="WhatsApp" className="w-5 h-5 object-contain shrink-0" />
    },
    {
        id: 'email',
        title: 'Email',
        subtitle: 'New email',
        icon: <img src="/gmail.png" alt="Email" className="w-5 h-5 object-contain shrink-0" />
    }
];
