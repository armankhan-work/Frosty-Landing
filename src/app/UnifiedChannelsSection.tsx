           ...
           >
              ...
              <div className="p-2.5 min-h-[125px] flex flex-col gap-1.5 relative overflow-hidden">
                 <div className="flex items-center gap-1.5 border-b border-slate-100 pb-1">
                     <img className="w-5 h-5 rounded-full shrink-0 object-cover border border-slate-200" src="https://i.pravatar.cc/150?img=68" alt="James Carter" />
            ...
            >
              ...
              <div className="p-6 flex flex-col gap-4">
                <div className="flex items-center gap-3.5 p-3 rounded-xl bg-teal-50/50 border border-teal-100/60">
                  <img src="https://i.pravatar.cc/150?img=68" alt="James Carter" className="w-12 h-12 rounded-full border border-teal-200 object-cover" />
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
